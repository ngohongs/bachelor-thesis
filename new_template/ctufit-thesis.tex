...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\ctufittitle{Simulování vodního povrchu} % replace with the title of your thesis
\ctufitauthorfull{Hong Son Ngo} % replace with your full name (first name(s) and then family name(s) / surname(s)) including academic degrees
\ctufitauthorsurnames{Ngo} % replace with your surname(s) / family name(s)
\ctufitauthorgivennames{Hong Son} % replace with your first name(s) / given name(s)
...
%\input{text/basic_theory}

%\input{text/chapter_one}

...
\begin{conclusion}
    ...
    Dalším cílem bylo vytvořit testovací scénu s vybraným algoritmem z analýzy  pro simulaci vodní plochy. Moji volbou byla metoda výpočtu vlnové rovnice a to z důvodu, že zahrnuje kladné vlastnosti jak procedulárních, tak i částicových metod simulace. Simulace podle vlnové rovnice zachovává výpočetní rychlost procedulárních metod a fyzikální korektnost částicových systémů. 

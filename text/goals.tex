...
Následně v praktické části je cílem vybrat vhodné simulační metody pro \emph{real-time} grafické aplikace,  navrhnout prototyp simulátoru a ve zvoleném nástroji ho implementovat a nakonec vytvořit testovací scénu, která simulaci demonstruje. 

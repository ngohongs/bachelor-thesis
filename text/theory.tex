...
\begin{figure}\centering
 	...
 	\caption{Ukázka off-line simulace Eulerovy tekutiny [guendelman et al siggraph 2005]}\label{fig:guendelman-offline}
\end{figure}
...
Podle tohodle principu můžeme dělit metody simulace vodní plochy na [gdc mueller]:
...
Mezi prvními, kdo zkoumal procedulární metody pro zobrazení vodního povrchu byl Nelson. L Max ve své práci \uv{Vectorized Procedural Modesl for Natural Terrain: Wave and Islands in the Sunset}, ve které modeluje vlnění povrchu pomocí funkce sinus.

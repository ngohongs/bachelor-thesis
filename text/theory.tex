...
\chapter{Technologie pro real-time simulaci}
    ...
    \chapter{Shrnutí analýzy}
        ...
        \section{Model požadavků}
            ...
            \begin{table}
                    \centering
                    \caption{Funkčních požadavků simulátoru a aplikace testovací scény.}
                    \begin{tabular}[t]{ | p{6em} | p{8cm} | } 
                        ...
                        Popis &  Simulátor bude vypočítavat kaustiky formované nerovností vodní hladiny a následně  je vykreslí na objekty pod ní. \\ 
                        Priorita & Musí  \\ 
                        \hline
                        Požadavek & Reflekce\\ 
                        ...
                        Priorita & Mohlo by  \\
                        Poznámka & Kvůli obtížnosti výpočtu lze tento požadavek nahradit volbou průhledné barvy pro vodní hladinu. Tato volba nebude brát v potaz zkreslení obrazu. \\
                        \hline
                        Požadavek & Útlum světla \\ 
                        Popis &  Simulátor bude regulovat osvětlení objektů pod hladinou na základě jejich vzdálenosti od hladi\\ 
                        Priorita & Mělo by  \\
                        \hline
                    \end{tabular}

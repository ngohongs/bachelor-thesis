   ...
   Pro každé i, j proveď
    ...
    \section{Optické vlastnosti}
        ...
        \subsection{Refrakce}
            ...
            \noindent kde $\theta_1$ značí úhel dopadu příchozího světla, $\theta_2$ je úhel lomoného paprsku, $n_1$ a $n_2$ jsou refraktivní index (IOR) příchozícho a odchozího prostředí.

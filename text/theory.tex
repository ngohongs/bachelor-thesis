...
\chapter{Technologie pro real-time simulaci}
    ...
    \section{Renderovací knihovny}
        Po výpočtu simulace musí aplikace nějakým způsobem zobrazit výslednou geometrii, k tomu slouží tzv. renderovací API. Renderovací API nabízí rozhraní, které umožňuje uživateli manipulovat obrazem skrz grafické karty.

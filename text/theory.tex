...
\chapter{Technologie pro real-time simulaci}
    ...
    \section{Renderovací knihovny}
        ...
        Aby bylo možné předat data o vodní ploše a informace, jak ji vykreslit na obrazovku, grafickým kartám se v programech používá tzv. grafických API. Grafické API nabízí rozhraní, které umožňuje uživateli manipulovat obraz skrz grafické karty.
